...
define('VIRTUAL_PATH', 'http://milo.sh/wn16/'); # Virtual (web) 'root' of application for images, JS & CSS files
define('PHYSICAL_PATH', '/home/milosherman/public_html/wn16/'); # Physical (PHP) 'root' of application for file & upload reference
...
define('SUPPORT_EMAIL', 'me@milo.sh'); # Email of site support
