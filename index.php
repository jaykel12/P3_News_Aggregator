...
/**
 *
 * index.php an initial version of the news aggregator
 *  
...
$sql = "SELECT CategoryID, CategoryName, Description FROM wn16_news_categories";
...
{#there are records - present data
	...
	{# pull data from associative array
	   echo '<p>';
	   echo '<a href="survey_view.php?id=' . $row['CategoryID'] . '">' . $row['CategoryName'] . '</a><br />';
